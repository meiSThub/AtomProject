...
![image-20220823195959574](https://raw.githubusercontent.com/meiSThub/BlogImage/master/2022image-20220823195959574.png)

执行该命令之后，在项目的根路径之下，就会生成一个 **.fvm** 的文件：

![image-20220823193933307](https://raw.githubusercontent.com/meiSThub/BlogImage/master/2022image-20220823193933307.png)

接下来，可用 **`fvm flutter`** 代替 **`flutter`** 命令，以便自动 **pick** 当前 工程 **所用的SDK**。

如 在项目的 **terminal** 中，执行 **`fvm flutter`**相关的命令了，如：

![image-20220823194110229](https://raw.githubusercontent.com/meiSThub/BlogImage/master/2022image-20220823194110229.png)
...
如：![image-20220823201338421](https://raw.githubusercontent.com/meiSThub/BlogImage/master/2022image-20220823201338421.png)
